...
- Workspace files survive Workspace-service and Worker restarts, and both Workers see the same selected directory; background job registry state remains process-local to the Workspace service and does not survive its restart.
